...
"""
panorama-openedx-backend documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'panorama-openedx-backend',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/aulasneo/panorama-openedx-backend",
...
#
# html_title = 'panorama-openedx-backend v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Django app that implements backend functions for Panorama MFE',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'panorama_openedx_backend'),
                os.path.join(root_path, 'panorama_openedx_backend/migrations')])
