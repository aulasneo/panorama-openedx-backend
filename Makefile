...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd panorama_openedx_backend && i18n_tool extract --no-segment

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd panorama_openedx_backend && i18n_tool generate

detect_changed_source_translations:
	cd panorama_openedx_backend && i18n_tool changed
...
pull_translations:
	find panorama_openedx_backend/conf/locale -mindepth 1 -maxdepth 1 -type d -exec rm -r {} \;
	atlas pull $(OPENEDX_ATLAS_ARGS) translations/panorama-openedx-backend/panorama_openedx_backend/conf/locale:panorama_openedx_backend/conf/locale
...
dummy_translations: ## generate dummy translation (.po) files
	cd panorama_openedx_backend && i18n_tool dummy
